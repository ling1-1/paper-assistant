...
export default async function handler(req, res) {
  ...
  const fieldPrompts = {
    general: '',
    cs: '【计算机科学领域】熟悉 AI、机器学习、分布式系统、算法等术语。',
    medicine: '【医学领域】熟悉临床医学、药理学、病理学等术语。',
    engineering: '【工程领域】熟悉机械、电子、土木、化工等术语。',
    biology: '【生物学领域】熟悉分子生物学、遗传学、生态学等术语。',
  };
